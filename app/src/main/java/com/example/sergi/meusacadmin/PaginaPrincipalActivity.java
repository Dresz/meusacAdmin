...
public class PaginaPrincipalActivity extends AppCompatActivity
    ...
    private void JsonParse(){
        ...
        String URL = getIp.ip+"catedratico/";
                    ...
                    public void onResponse(JSONArray jsonArray) {
                        for (int i =0; i < jsonArray.length();i++) {
                            try{
                                ...
                                TextView nombre = (TextView) findViewById(R.id.txtNavNombre);
                                nombre.setText(name);
                                TextView id = (TextView) findViewById(R.id.txtNavCorreo);
                                id.setText(carnet);
